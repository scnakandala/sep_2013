<div class="students index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('index_number');?></th>
			<th><?php echo $this->Paginator->sort('name');?></th>
			<th><?php echo $this->Paginator->sort('gmail_address');?></th>
			<th><?php echo $this->Paginator->sort('mid_marks');?></th>
	...
	<tr>
		...
		<td><?php echo h($student['Student']['index_number']); ?>&nbsp;</td>
		<td><?php echo h($student['Student']['name']); ?>&nbsp;</td>
		<td><?php echo h($student['Student']['gmail_address']); ?>&nbsp;</td>
		<td><?php echo h($student['Student']['mid_marks']); ?>&nbsp;</td>
		<td class="actions">
