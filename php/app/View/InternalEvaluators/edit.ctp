...
<?php echo $this->Form->create('InternalEvaluator');?>
	<fieldset>
		<legend><?php echo __('Edit Internal Evaluator'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('InternalEvaluator.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('InternalEvaluator.id'))); ?></li>
