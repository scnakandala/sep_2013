...
<?php echo $this->Form->create('ExternalEvaluator');?>
	<fieldset>
		<legend><?php echo __('Edit External Evaluator'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ExternalEvaluator.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ExternalEvaluator.id'))); ?></li>
